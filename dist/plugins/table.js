...
function cell_style(editor, value, applyTo) {
    ...
    if (applyTo === "cell") {
        ...
        Array.from((_a = node.parentElement) === null || _a === void 0 ? void 0 : _a.querySelectorAll(node.nodeName)).forEach(n => n.setAttribute("style", value));
    }
    else if (applyTo === "all") {
...
function table_function(editor, value) {
            ...
            if (!tr.contains(td)) {
                ...
                if (1 < rowSpan) {
                    if (rowSpan === 2)
                        ...
                        td.setAttribute("rowspan", (rowSpan - 1).toString());
                }
                return;
            }
    ...
    func['delete_column'] = () => {
        ...
        trs.forEach((r, idx) => {
            if (r === tr) {
                ...
                for (var i = 0, t = IndexDelete.length; i < t; i++) {
                    if (prevNode === nodeList[IndexDelete[i]] || !nodeList[IndexDelete[i]])
                        continue;
        ...
        if ((tbody === null || tbody === void 0 ? void 0 : tbody.querySelectorAll("td").length) === 0)
            table.remove();
    };
    ...
    func['merge_down'] = () => {
        ...
        if (editor.dom.table.colSpan(nodeList[col]) !== editor.dom.table.colSpan(nextNodeList[col]))
            return;
...
exports.default = [
    ...
    },
    {
        ...
        callback: (editor, cmd, value, styleValue, styleApplyTo) => {
            ...
            if (insertAfterIdx !== -1) {
                editor.dom.nodesInsertAfter([document.createElement("br"), table], editor.feature.path.length > insertAfterIdx + 1 && editor.feature.path[insertAfterIdx] === "CODE" && editor.feature.path[insertAfterIdx + 1] === "PRE" ? editor.feature.pathNode[insertAfterIdx + 1] :
            ...
            if (pNode && table.parentElement) {
                //break paragraph
                if (((_a = table.parentElement) === null || _a === void 0 ? void 0 : _a.nodeName) === "P") {
