...
exports.cleanupHtml = exports.mergeTag = exports.getType = void 0;
...
function cleanupHtml(html) {
    ...
    for (let i = length - 1; i >= 0; i--) {
        ...
        //is text or span
        if (prev && ((prev.nodeType === 3 && !curStyle) //span with no style can merge with text node
            ||
                (prev.nodeName === "SPAN" && curStyle === prev.getAttribute("style")) //span with exact style can merge together
        )) {
            prev.textContent += cur.textContent || "";
            (_a = cur.parentNode) === null || _a === void 0 ? void 0 : _a.removeChild(cur);
        }
